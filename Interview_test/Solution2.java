...
public class Solution2 {
     ...
     */
    public static int whoIsElected(int numberOfStudent, int lengthOfSong) {
        //your code
        if (numberOfStudent ==1) return 1;
        else {
            System.out.println("numberOfStudent = " + numberOfStudent + " lengthOfSong = " + lengthOfSong);
            return  (whoIsElected(numberOfStudent - 1, lengthOfSong) + lengthOfSong - 1) % numberOfStudent + 1;
        }
